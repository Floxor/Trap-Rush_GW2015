...
TR_start.prototype = {
	...
	create : function (Game) {
		...
		Game.bots = [];
		Game.player1 = new Player(Game,Game.selected.name,[150,600],1);
		Game.player2 = new Player(Game,"placeholder2",[250,600],2);
		Game.pickableGroup = [];
		for (var i = 3 - 1; i >= 0; i--) {
		...
		Game.end = Game.add.sprite(3650	, 250, 'placeholder5');
		Game.physics.enable(Game.end, Phaser.Physics.ARCADE);
		Game.end.body.allowGravity = false;
	...
	update: function(Game){
		...
		Game.physics.arcade.collide(Game.player1.sprite, Game.end.sprite, victoire);
